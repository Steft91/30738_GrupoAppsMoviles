...
\subsection{Filtrar en orden alfabético}
La lista de contactos se puede filtrar en orden alfabético ascendente o deshacer la filtración.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{img/desorden.png}
    \caption{Lista de contactos sin ordenar.}
    \label{fig:ascendente}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{img/ascendente.png}
    \caption{Lista de contactos en orden ascendente.}
    \label{fig:ascendente}
\end{figure}
...
Link de GitHub: \url{https://github.com/Steft91/30738_GrupoAppsMoviles/tree/main/3P/pry_2sqlite}
